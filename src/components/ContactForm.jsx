    ...
    <div  className='flex flex-col items-justify md:items-center lg:items-end'>
      <form onSubmit={handleSubmit} className='flex flex-col justify-center'>
        <div className='py-8'>
          ...
          />
          {errors.name && <p className="text-red-500 text-center mt-3 ">{errors.name}</p>}
        </div>
        ...
        <div className='py-6'>
          ...
          <input
            ...
            className='block w-[300px] md:w-[500px] mt-3 border  mx-auto bg-black'
          />
          {errors.email && <p className="text-red-500 text-center mt-3 ">{errors.email}</p>}
        </div>
        ...
        <div className='py-6'>
          ...
          />
          {errors.message && <p className="text-red-500 text-center mt-3 ">{errors.message}</p>}
        </div>
